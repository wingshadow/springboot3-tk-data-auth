...
public class SysMenuServiceImpl extends BaseServiceImpl<SysMenu> implements SysMenuService {
    ...
    public List<SysMenu> selectMenuList(SysMenu menu, Long userId) {
        ...
        if (LoginHelper.isAdmin(userId)) {
            ...
            menuList = baseMapper.selectByExample(example);
        } else {
            menuList = baseMapper.selectMenuListByUserId(userId, menu);
        }
        return menuList;
    }
    ...
    public List<SysMenu> selectMenuTreeByUserId(Long userId) {
        ...
        if (CollUtil.isEmpty(menus)) {
            menus = baseMapper.defaultMenu("5");
        }
    ...
    public SysMenu selectMenuById(Long menuId) {
        return baseMapper.selectByPrimaryKey(menuId);
    }
    ...
    public int deleteMenuById(Long menuId) {
        return baseMapper.deleteByPrimaryKey(menuId);
    }
